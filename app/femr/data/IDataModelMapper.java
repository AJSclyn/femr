...
public interface IDataModelMapper {
     ...
     * @param uniqueId  patient unique Id
     * @return an implementation of IPatient or null if processing fails
     */
    IPatient createPatient(int userID, String firstName, String lastName, Date birthday, String sex, String address, String city, Integer photoID, String uniqueId);
